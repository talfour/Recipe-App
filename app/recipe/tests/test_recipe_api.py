...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title="Tahini with eggplant")
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title="Chicken with potatoes")
        r2 = create_recipe(user=self.user, title="Pork in curry")
        ing1 = Ingredient.objects.create(user=self.user, name="Chicken")
        ing2 = Ingredient.objects.create(user=self.user, name="Pork")
        r1.ingredients.add(ing1)
        r2.ingredients.add(ing2)
        r3 = create_recipe(user=self.user, title="Vegetable curry")
...
class ImageUploadTests(TestCase):
    ...
    def setUp(self):
        ...
        self.user = get_user_model().objects.create_user(
            "user123@example.com", "testpass123"
        )
        self.client.force_authenticate(self.user)
